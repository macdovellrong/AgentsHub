export const UI_TEXT = {
  ...
  buttons: {
    ...
    delete: "删除",
    send: "发送",
    generateTaskPlan: "生成任务计划",
    queue: "加入队列",
    pause: "暂停",
    create: "创建",
    createTaskPlan: "新建任务计划",
    startTaskPlanManager: "交给 Claude 管理",
    openTaskPlanFolder: "打开计划目录",
  },
  sections: {
    profiles: "智能体",
    profileEditor: "角色配置",
  ...
  placeholders: {
    ...
    taskPlanTitle: "计划标题（从选中的 tasks 目录创建快照）",
  },
  hints: {
    taskPlanSource: "读取当前工作区 tasks/<时间-标题>/task-plan.md，并保存为这次执行的历史快照。",
  },
  empty: {
    events: "当前工作目录暂无事件。",
    forwards: "当前工作目录暂无转发记录。",
    taskPlans: "暂无任务计划。",
    taskPlanSources: "未找到 tasks/*/task-plan.md",
    taskPlanMarkdown: "选择计划查看创建时快照。",
